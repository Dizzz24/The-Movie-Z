...
export default function Navbar() {
    ...
    return (
        <nav className="bg-gray-900 dark:bg-gray-800 fixed w-full z-20 top-0 left-0 border-b border-gray-600 dark:border-gray-700">
            <div className="w-screen flex items-center justify-between mx-lg p-4">
                <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    {/* <img src="" className="h-8" alt="Movie-z" /> */}
                    <span className="self-center text-2xl font-semibold whitespace-nowrap text-white dark:text-gray-200">The Movie-Z</span>
                </Link>
